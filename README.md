...
## The problem
An e-shop wants to increase their revenue by suggesting items similar to the items customers have put in their baskets, while they are shopping online.
...
The target of the recommender engine is to suggest to each of these customers, other items that are very similar to the items they already have put in their baskets.
...
The training set consists of 7,453 unique customers that have purchased at least 20 items.

<img src="images/c30.png" width="85%">

The test set consists of 6 unique customers selected from multitude of customers that have bought less than 3 items.
...
* The devloped engine recommends exactly the same items that are already in the customer's baskets. This can be frustrating and confusing for the customer. In the later versions, this needs to be dealt with and these items should be filtered out.
